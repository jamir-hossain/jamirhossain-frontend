const worksData = [
  ...
  },
  {
    ...
    features: ["Select Any food in the Cart.", "Order food from the Cart.", "Have to Sign Up to place an order.", "Pay online using your credit card.", "See all the order details.", "Users can see their logged-in profile.", "Users can see their order details."],
