const worksData = [
  {
    ...
    description:"A single page MERN Stack restaurant app where people are able to select food in their cart and checkout the cart with their information.",
  ...
  },
  {
    ...
    description:"A Single page MERN Stack hospital web-app with dashboard where people can get an appointment. A doctor can review his appointments and prescribe medicine to a Patient from his dashboard.",
  ...
  {
    title: "Employees Salary Information",
    image: "https://res.cloudinary.com/dj7k9b8ps/image/upload/v1606132023/projectImage/ibjvw9jfq2x39fufzpwx.png",
    description:"A Single-page web app. The author can give salary to every employee in her company in here. At the same time, the author can see her company's revenue and total balance. ",
